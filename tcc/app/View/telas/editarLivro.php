...
<div class="ui center aligned page grid">
    <div class="ui eight wide column left aligned form segment grid" style=" margin-top: 6%; margin-bottom: 5%">
        <form class="ui form" action="ControlerLivro.php?acao=editarLivro" method="post"">
        <h2 class="ui dividing header">Editar livro "<?=$livro->li_titulo?>":</h2>
        <div class="field">
            <label>Titulo do Livro</label>
            <input type="text" name="li_titulo" placeholder="<?=$livro->li_titulo?>" required>
        </div>
        <div class="field">
            <label>Número de paginas</label>
            <input type="number" name="li_paginas" placeholder="<?=$livro->li_paginas?>" min="0" max="3000" required>
        </div>
        <div class="field">
            <label>Autor</label>
            <input type="text" name="li_autor" placeholder="<?=$livro->li_autor?>" required>
        </div>
        <div class="field">
            <label>Ano de publicação</label>
            <input type="number" name="li_ano" placeholder="<?=$livro->li_ano?>" required>
        </div>
        <div class="field">
        ...
        <div class="field">
            <label>Editora</label>
            <input type="text" name="li_editora" placeholder="<?=$livro->li_editora?>" required>
        </div>
        <div class="field">
        ...
        <input style="visibility: hidden; " type="text" name="getidlivro" value="<?=$livro->li_idlivro?>">
