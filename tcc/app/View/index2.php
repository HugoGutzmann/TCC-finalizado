...
if (isset($_SESSION)) {
    ...
    <a class="ui right floated icon button" style="margin-right: 20px "
       href="ControlerUsuario.php?acao=index&idusuario=<?= $id ?>">
        <i class="plus icon"></i>
        Ativar formulário
    </a>
    <?php
            ...
            <div id="card" class="ui card" style="height:550px; width:255px">
                ...
                if (isset($nomeCapa['arquivo'])){
                    ...
                    <a class="image" href="ControlerLivro.php?acao=show<?php if (isset($_SESSION)){$id = $_SESSION['us_id'];echo "&idusuario=".$id;}?>&idlivro=<?= $livro->li_idlivro ?>" style="cursor: pointer">
                        <img href="ControlerLivro.php?acao=show" src="../../assets/img/livros/<?= $nomeCapa['arquivo'] ?>" style="height:400px; width:255px">
                    </a>
                    <?php
                }else {
                    ?>
                    <a class="image" href="ControlerLivro.php?acao=show<?php if (isset($_SESSION)) {
                        ...
                        <img href="ControlerLivro.php?acao=show" src="../../assets/img/livros/default.jpg" style="height:400px; width:255px">
                    </a>
                    <?php
                }
                ?>
                <div class="content">
                    ...
                    <div class="ui flowing popup top left transition hidden" style="width: 250px">
                        ...
                        <div class="content">
                            <form method="post" class="ui form" action="../../app/Controlers/ControlerLivro.php?acao=add_livroprateleira2&idusuario=<?=$id?>">
                                <div class="field">
                                    ...
                                    <input style="visibility: hidden; padding: 0px" type="text" name="getidlivro" value="<?=$livro->li_idlivro?>">
                                </div>
